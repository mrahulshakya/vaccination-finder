 ...
 <table>
        ...
        <tbody>
            <tr>
                ...
                <td v-if="district && district.length > 0"><v-select v-model="activeDistrict" name="district" :options="district" label="district_name" @option:selected="savePreferences"></v-select></td>
